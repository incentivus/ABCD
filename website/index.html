...
<!--        <button id="myBtn" class="btnn" style="height: 500px;">Open Modal</button>-->
    ...
    <div class="row">
        <div class="col-sm-4 ">
            <div class="card alice">
                <div class="card-body ">
                    <h5 class="card-title text-center heading">Alice</h5>
                        <div id="alice-msg-box"></div>

                </div>
                    <a hidden href="#" class="btn btn-primary card-footer btnqs" id="alice-yes">Yes</a>
                    <a hidden href="#" class="btn btn-primary card-footer btnqs" id="alice-no">No</a>
                <div id="alice-balance" class="card-footer"></div>
            </div>
        </div>
        <div class="col-sm-4 ">
            <div class="card bob">
                <div class="card-body ">
                    <h5 class="card-title text-center heading">Bob</h5>
                        <div id="bob-msg-box"></div>

                </div>
                    <a hidden href="#" class="btn btn-primary btnqs card-footer" id="bob-yes">Yes</a>
                    <a hidden href="#" class="btn btn-primary btnqs card-footer" id="bob-no">No</a>
                <div id="bob-balance" class="card-footer"></div>
            </div>
        </div>
        <div class="col-sm-4 ">
            <div class="card carol">
                <div class="card-body ">
                    <h5 class="card-title text-center heading">Carol</h5>
                        <div id="carol-msg-box"></div>

                </div>
                    <a hidden href="#" class="btn btn-primary btnqs card-footer" id="carol-yes">Yes</a>
                    <a hidden href="#" class="btn btn-primary btnqs card-footer" id="carol-no">No</a>
                <div id="carol-balance" class="card-footer"></div>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-4">
            <button class="next-button" id="next">Next Step</button>
        </div>
    </div>
</body>
<style>
    ...
    websocket.onmessage = function (event) {
        ...
        switch (data.type) {
            ...
            case 'update-message':
                ...
                msg.innerHTML = data.id + "." + data.value;
                break;
            case 'question':
                qs = data
                var newMsg = sampleMsg.cloneNode(true);
                newMsg.innerHTML = data.id + "." + data.value;
...
<script>
    ...
    nxtBtn.onclick = function() {
        websocket.send(JSON.stringify({"type": 'next', "value": "T"}));
    }
</script>
</html>
