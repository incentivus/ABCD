...
async def main():
    ...
    await BOB.new_message("Audited Alic's funding transaction.")
    ...
    await ALICE.new_message("Premium deposition transaction is broadcasted.")
    ...
    await BOB.new_message("Margin deposition transaction is broadcasted.")
